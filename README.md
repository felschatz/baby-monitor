...
- If site data is cleared, choose the same Music parent folder again. Existing playlists are rescanned, and the download action checks for missing files without replacing non-empty tracks
